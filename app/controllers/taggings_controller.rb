class TaggingsController < ApplicationController
  def index
    ...
    @taggings = @q.result(:distinct => true).includes(:data_card, :tag, :user).page(params[:page]).per(10)
  ...
  def create
    ...
    @tagging.data_card_id = params[:data_card_id]
    @tagging.user_id = params[:user_id]
